 ...
 *
 *	
 *	Revision 1.1.1.1  2004/08/12 22:56:32  rfranz
 *	import of original u-boot 1.1.1 sources, non-mips support trimmed
 *	
...
static const char SysKonnectFileId[] =
	"@(#) $Id: skrlmt.c 21367 2007-01-03 01:35:24Z rfranz $ (C) SysKonnect.";
#endif	/* !defined(lint) */
