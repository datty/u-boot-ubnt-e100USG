...
int do_mii45 (cmd_tbl_t * cmdtp, int flag, int argc, char *argv[])
{
    char        op;
...
U_BOOT_CMD(
	...
	"mii45 read  <addr> <dev> <reg>        - read  MII PHY <addr> <dev> register <reg>\n"
	"mii45 dump  <addr> <dev> <start_reg> <end_reg>        - dump range of registers \n"
	"mii45 write <addr> <dev> <data> - write MII PHY <addr> <dev> register <reg>\n"
