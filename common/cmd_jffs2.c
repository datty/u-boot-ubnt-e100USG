 ...
 *   kernel tree.
 *
 *   $Id: cmd_jffs2.c 41157 2009-03-04 00:45:08Z rfranz $
...
/***************************************************/
U_BOOT_CMD(
	jffs2load,	3,	0,	do_jffs2_fsload,
	"jffs2load\t- load binary file from a filesystem image\n",
	"[ off ] [ filename ]\n"
	"    - load binary file from flash bank\n"
	"      with offset 'off'\n"
);
U_BOOT_CMD(
	jffs2ls,	2,	1,	do_jffs2_ls,
	"jffs2ls\t- list files in a directory (default /)\n",
	"[ directory ]\n"
	"    - list files in a directory.\n"
);

U_BOOT_CMD(
	jffs2info,	1,	1,	do_jffs2_fsinfo,
	"jffs2info\t- print information about filesystems\n",
	"    - print information about filesystems\n"
);

#ifdef CONFIG_JFFS2_CMDLINE
U_BOOT_CMD(
	jffs2chpart,	2,	0,	do_jffs2_chpart,
	"jffs2chpart\t- change active partition\n",
	"part-id\n"
