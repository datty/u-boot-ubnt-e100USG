...
int early_board_init(void)
{
    ...
    else
    {
        ...
        gd->board_desc.board_type = CVMX_BOARD_TYPE_EBH5200;
#elif CONFIG_OCTEON_EBH5201
        gd->board_desc.board_type = CVMX_BOARD_TYPE_EBH5201;
#elif CONFIG_OCTEON_EBT5200
        gd->board_desc.board_type = CVMX_BOARD_TYPE_EBT5200;
#endif
    ...
    */
    ...
    {
        gd->ddr_clock_mhz = EBH5200_DEF_DRAM_FREQ;
    }
