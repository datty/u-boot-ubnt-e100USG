...
/* NOTE:  This file is shared by both the ebh5600 and ebh5600 boards, as they are very similar.
** Conditional compilation will be used as necessary to make changes.
*/
...
int early_board_init(void)
{
    ...
    {
        gd->ddr_clock_mhz = EBH5600_DEF_DRAM_FREQ;
    }
...
#if CONFIG_OCTEON_EBH5600
        gd->board_desc.board_type = CVMX_BOARD_TYPE_EBH5600;
#elif CONFIG_OCTEON_EBH5601
        gd->board_desc.board_type = CVMX_BOARD_TYPE_EBH5601;
#else
        gd->board_desc.board_type = CVMX_BOARD_TYPE_EBT5600;
#endif
