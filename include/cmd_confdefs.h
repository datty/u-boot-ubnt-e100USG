...
#define CFG_CMD_OCTEON_BOOTLOADER_UPDATE	0x0100000000000000ULL	/* Octeon bootloader update command */
...
#define CFG_CMD_OCTEON_NAND       0x0800000000000000ULL	/* Octeon NAND support*/
#define CFG_CMD_EXT2	0x1000000000000000ULL	/* EXT2 Support			*/
#define CFG_CMD_SNTP	0x2000000000000000ULL	/* SNTP support			*/
#define CFG_CMD_GUNZIP	0x4000000000000000ULL	/* Gunzip command	`	*/
#define CFG_CMD_OCTEON	0x8000000000000000ULL	/* OCTEON Executive format	*/
...
#define ENABLE_BOOTP_AND_RARP   0
...
/*
 * Set some new config defines based on what is in CONFIG_COMMANDS.  We have a mix of old
 * and new code.
 */
    ...
    #define CONFIG_SYS_JFFS2_SORT_FRAGMENTS   /* Required for deleted file handling */
#endif
