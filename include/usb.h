...
/* Same as cvmx_usb_control_header_t */
struct devrequest {
...
struct usb_device {
	...
	struct usb_device *children[USB_MAXCHILDREN];
        int split_hub_id;               /* hub info for split transactions.  hub_id of 0 means no splitting */
        int split_hub_port;
};
...
#if defined(CONFIG_USB_UHCI) || defined(CONFIG_USB_OHCI) || defined (CONFIG_USB_SL811HS) || defined (CONFIG_USB_OCTEON)
 ...
 *  - endpoint:		bits 15-18
 *  - Data0/1:		bit 19
 *  - speed:		bit 26-27	(0 = Full, 1 = Low Speed, 2 = High Speed)
...
#define default_pipe(dev) ((dev)->speed == 0)
