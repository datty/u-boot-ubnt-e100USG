...
/* Define something in RAM */
#define CFG_NORMAL_BOOTLOADER_BASE  0x100000
...
#define CONFIG_COMMANDS		((CONFIG_CMD_DFL | CFG_CMD_ELF | CFG_CMD_OCTEON | CFG_CMD_LOADB | CFG_CMD_FLASH \
                                  | CFG_CMD_ENV | CFG_CMD_RUN | CFG_CMD_JFFS2 | CFG_CMD_NAND | CFG_CMD_OCTEON_NAND \
                                  | CFG_CMD_NET | CFG_CMD_DHCP | CFG_CMD_PING | CFG_CMD_MII | CFG_CMD_I2C | CFG_CMD_OCTEON_BOOTLOADER_UPDATE \
...
#define CFG_ENV_IS_IN_RAM   1
#undef  CFG_ENV_SIZE
#define CFG_ENV_SIZE     U_BOOT_RAM_ENV_SIZE
