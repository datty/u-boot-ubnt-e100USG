 ...
 * Copyright 2004,2005,2008 Cavium Networks
 *
 ...
 * pciboot based board.  Since the host that is doing the PCI boot is responsible
 * for DDR configuration, u-boot needs to do very little to get basic
...
#define CONFIG_OCTEON_NO_FAILSAFE  /* We don't use a failsafe on this board */
...
*/
#define CFG_NORMAL_BOOTLOADER_BASE  0x1fc00000
...
/*
** This board does not use the internal arbiter in Octeon.
...
#define CONFIG_COMMANDS		((CONFIG_CMD_DFL | CFG_CMD_ELF | CFG_CMD_OCTEON | CFG_CMD_LOADB | CFG_CMD_FLASH \
                                  | CFG_CMD_ENV | CFG_CMD_RUN | CFG_CMD_FAT \
                                  | CFG_CMD_NET | CFG_CMD_DHCP | CFG_CMD_PING | CFG_CMD_MII | CFG_CMD_I2C | CFG_CMD_EEPROM | CFG_CMD_IDE \
...
#define CFG_I2C_EEPROM_ADDR     OCTEON_NIC_XLE_4G_EEPROM_ADDR
#endif
 ...
 * Set CFG_MAX_FLASH_BANKS to 0 so no init is done - this will hang some boards....
 */
...
/* DRAM configuration is the same as the NIC_XLE_4G */
